...
PLACEMENT_SUCCESS_BONUS_WEIGHT = 2000.0
...
class RewardsCfg:
    ...
    placement_success_bonus = RewTerm(
        func=rewards.compute_terminal_object_in_bowl_success_reward,
        weight=PLACEMENT_SUCCESS_BONUS_WEIGHT,
    )
